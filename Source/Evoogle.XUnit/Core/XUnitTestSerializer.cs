...
public class XUnitTestSerializer : IXunitSerializer
{
    ...
    public bool IsSerializable(Type type, object? value, [NotNullWhen(false)] out string? failureReason)
    {
        ...
        failureReason = $"Type {{Name={type.Name}}} cannot be serialized by {nameof(XUnitTestSerializer)} because it is not a subclass of {nameof(XUnitTest)} or {nameof(XUnitTestAsync)}.";
        return false;
    }
