...
public class ByteArrayTests(ITestOutputHelper output) : CoerceTests(output)
{
    ...
    [
        ...
        new GenericCoerceTest<byte[], ColorSet1>{ Name = $"ByteArray To Enum ({TestByteArrayString})", Input = TestByteArray, ExpectedResult = false },
    ...
    [
        ...
        new NonGenericCoerceTest<byte[], ColorSet1>{ Name = $"ByteArray To Enum ({TestByteArrayString})", Input = TestByteArray, ExpectedResult = false },
