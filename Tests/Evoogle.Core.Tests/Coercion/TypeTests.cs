...
public class TypeTests(ITestOutputHelper output) : CoerceTests(output)
{
    ...
    [
        ...
        new GenericCoerceTest<Type, PrimaryColor>{ Name = $"Type To Enum ({TestTypeString})", Input = TestType, ExpectedResult = false },
    ...
    [
        ...
        new NonGenericCoerceTest<Type, PrimaryColor>{ Name = $"Type To Enum ({TestTypeString})", Input = TestType, ExpectedResult = false },
