...
public class StringTests(ITestOutputHelper output) : CoerceTests(output)
{
    ...
    [
        ...
        new GenericCoerceTest<string, ColorSet1>{ Name = "String To Enum (1)", Input = "1", ExpectedResult = true, ExpectedOutput = ColorSet1.Red },
        new GenericCoerceTest<string, ColorSet1>{ Name = "String To Enum (42)", Input = "42", ExpectedResult = false },
        new GenericCoerceTest<string, ColorSet1>{ Name = "String To Enum (Green)", Input = "Green", ExpectedResult = true, ExpectedOutput = ColorSet1.Green },
    ...
    [
        ...
        new NonGenericCoerceTest<string, ColorSet1>{ Name = "String To Enum (1)", Input = "1", ExpectedResult = true, ExpectedOutput = ColorSet1.Red },
        new NonGenericCoerceTest<string, ColorSet1>{ Name = "String To Enum (42)", Input = "42", ExpectedResult = false },
        new NonGenericCoerceTest<string, ColorSet1>{ Name = "String To Enum (Green)", Input = "Green", ExpectedResult = true, ExpectedOutput = ColorSet1.Green },
