...
public class UShortTests(ITestOutputHelper output) : CoerceTests(output)
{
    ...
    [
        ...
        new GenericCoerceTest<ushort, ColorSet1>{ Name = "UShort To Enum (1)", Input = 1, ExpectedResult = true, ExpectedOutput = ColorSet1.Red },
        new GenericCoerceTest<ushort, ColorSet1>{ Name = "UShort To Enum (42)", Input = 42, ExpectedResult = false },
    ...
    [
        ...
        new NonGenericCoerceTest<ushort, ColorSet1>{ Name = "UShort To Enum (1)", Input = 1, ExpectedResult = true, ExpectedOutput = ColorSet1.Red },
        new NonGenericCoerceTest<ushort, ColorSet1>{ Name = "UShort To Enum (42)", Input = 42, ExpectedResult = false },
