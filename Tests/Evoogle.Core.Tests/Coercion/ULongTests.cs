...
public class ULongTests(ITestOutputHelper output) : CoerceTests(output)
{
    ...
    [
        ...
        new GenericCoerceTest<ulong, ColorSet1>{ Name = "ULong To Enum (1)", Input = 1, ExpectedResult = true, ExpectedOutput = ColorSet1.Red },
        new GenericCoerceTest<ulong, ColorSet1>{ Name = "ULong To Enum (42)", Input = 42, ExpectedResult = false },
    ...
    [
        ...
        new NonGenericCoerceTest<ulong, ColorSet1>{ Name = "ULong To Enum (1)", Input = 1, ExpectedResult = true, ExpectedOutput = ColorSet1.Red },
        new NonGenericCoerceTest<ulong, ColorSet1>{ Name = "ULong To Enum (42)", Input = 42, ExpectedResult = false },
