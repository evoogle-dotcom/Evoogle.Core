...
public class ByteTests(ITestOutputHelper output) : CoerceTests(output)
{
    ...
    [
        ...
        new GenericCoerceTest<byte, ColorSet1>{ Name = "Byte To Enum (1)", Input = 1, ExpectedResult = true, ExpectedOutput = ColorSet1.Red },
        new GenericCoerceTest<byte, ColorSet1>{ Name = "Byte To Enum (42)", Input = 42, ExpectedResult = false },
    ...
    [
        ...
        new NonGenericCoerceTest<byte, ColorSet1>{ Name = "Byte To Enum (1)", Input = 1, ExpectedResult = true, ExpectedOutput = ColorSet1.Red },
        new NonGenericCoerceTest<byte, ColorSet1>{ Name = "Byte To Enum (42)", Input = 42, ExpectedResult = false },
