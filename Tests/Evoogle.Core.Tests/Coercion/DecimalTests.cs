...
public class DecimalTests(ITestOutputHelper output) : CoerceTests(output)
{
    ...
    [
        ...
        new GenericCoerceTest<decimal, PrimaryColor>{ Name = "Decimal To Enum (1)", Input = 1, ExpectedResult = true, ExpectedOutput = PrimaryColor.Green },
        new GenericCoerceTest<decimal, PrimaryColor>{ Name = "Decimal To Enum (42)", Input = 42, ExpectedResult = false },
    ...
    [
        ...
        new NonGenericCoerceTest<decimal, PrimaryColor>{ Name = "Decimal To Enum (1)", Input = 1, ExpectedResult = true, ExpectedOutput = PrimaryColor.Green },
        new NonGenericCoerceTest<decimal, PrimaryColor>{ Name = "Decimal To Enum (42)", Input = 42, ExpectedResult = false },
