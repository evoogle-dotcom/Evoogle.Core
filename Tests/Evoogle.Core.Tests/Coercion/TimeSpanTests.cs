...
public class TimeSpanTests(ITestOutputHelper output) : CoerceTests(output)
{
    ...
    [
        ...
        new GenericCoerceTest<TimeSpan, ColorSet1>{ Name = $"TimeSpan To Enum ({TestTimeSpanString})", Input = TestTimeSpan, ExpectedResult = false },
    ...
    [
        ...
        new NonGenericCoerceTest<TimeSpan, ColorSet1>{ Name = $"TimeSpan To Enum ({TestTimeSpanString})", Input = TestTimeSpan, ExpectedResult = false },
