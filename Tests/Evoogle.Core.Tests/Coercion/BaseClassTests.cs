...
public class BaseClassTests(ITestOutputHelper output) : CoerceTests(output)
{
    ...
    [
        ...
        new GenericCoerceTest<BaseClass, ColorSet1>{ Name = $"BaseClass To Enum ({nameof(BaseClass)})", Input = TestBaseClass, ExpectedResult = false },
    ...
    [
        ...
        new NonGenericCoerceTest<BaseClass, ColorSet1>{ Name = $"BaseClass To Enum ({nameof(BaseClass)})", Input = TestBaseClass, ExpectedResult = false },
