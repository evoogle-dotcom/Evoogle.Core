...
public class GuidTests(ITestOutputHelper output) : CoerceTests(output)
{
    ...
    [
        ...
        new GenericCoerceTest<Guid, ColorSet1>{ Name = $"Guid To Enum ({TestGuidString})", Input = TestGuid, ExpectedResult = false },
    ...
    [
        ...
        new NonGenericCoerceTest<Guid, ColorSet1>{ Name = $"Guid To Enum ({TestGuidString})", Input = TestGuid, ExpectedResult = false },
