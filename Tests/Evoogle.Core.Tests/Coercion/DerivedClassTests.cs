...
public class DerivedClassTests(ITestOutputHelper output) : CoerceTests(output)
{
    ...
    [
        ...
        new GenericCoerceTest<DerivedClass, PrimaryColor>{ Name = $"DerivedClass To Enum ({nameof(DerivedClass)})", Input = TestDerivedClass, ExpectedResult = false },
    ...
    [
        ...
        new NonGenericCoerceTest<DerivedClass, PrimaryColor>{ Name = $"DerivedClass To Enum ({nameof(DerivedClass)})", Input = TestDerivedClass, ExpectedResult = false },
