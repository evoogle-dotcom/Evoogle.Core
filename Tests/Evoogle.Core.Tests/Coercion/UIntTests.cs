...
public class UIntTests(ITestOutputHelper output) : CoerceTests(output)
{
    ...
    [
        ...
        new GenericCoerceTest<uint, PrimaryColor>{ Name = "UInt To Enum (1)", Input = 1, ExpectedResult = true, ExpectedOutput = PrimaryColor.Green },
        new GenericCoerceTest<uint, PrimaryColor>{ Name = "UInt To Enum (42)", Input = 42, ExpectedResult = false },
    ...
    [
        ...
        new NonGenericCoerceTest<uint, PrimaryColor>{ Name = "UInt To Enum (1)", Input = 1, ExpectedResult = true, ExpectedOutput = PrimaryColor.Green },
        new NonGenericCoerceTest<uint, PrimaryColor>{ Name = "UInt To Enum (42)", Input = 42, ExpectedResult = false },
