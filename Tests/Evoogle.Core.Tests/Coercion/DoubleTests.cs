...
public class DoubleTests(ITestOutputHelper output) : CoerceTests(output)
{
    ...
    [
        ...
        new GenericCoerceTest<double, PrimaryColor>{ Name = "Double To Enum (1)", Input = 1, ExpectedResult = true, ExpectedOutput = PrimaryColor.Green },
        new GenericCoerceTest<double, PrimaryColor>{ Name = "Double To Enum (42)", Input = 42, ExpectedResult = false },
    ...
    [
        ...
        new NonGenericCoerceTest<double, PrimaryColor>{ Name = "Double To Enum (1)", Input = 1, ExpectedResult = true, ExpectedOutput = PrimaryColor.Green },
        new NonGenericCoerceTest<double, PrimaryColor>{ Name = "Double To Enum (42)", Input = 42, ExpectedResult = false },
