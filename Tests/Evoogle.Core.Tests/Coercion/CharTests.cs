...
public class CharTests(ITestOutputHelper output) : CoerceTests(output)
{
    ...
    [
        ...
        new GenericCoerceTest<char, PrimaryColor>{ Name = "Char To Enum ('*')", Input = '*', ExpectedResult = false },
    ...
    [
        ...
        new NonGenericCoerceTest<char, PrimaryColor>{ Name = "Char To Enum ('*')", Input = '*', ExpectedResult = false },
