...
public class CharTests(ITestOutputHelper output) : CoerceTests(output)
{
    ...
    [
        ...
        new GenericCoerceTest<char, decimal>{ Name = "Char To Decimal ('*')", Input = '*', ExpectedResult = true, ExpectedOutput = '*' },
        new GenericCoerceTest<char, double>{ Name = "Char To Double ('*')", Input = '*', ExpectedResult = true, ExpectedOutput = '*' },
        new GenericCoerceTest<char, float>{ Name = "Char To Float ('*')", Input = '*', ExpectedResult = true, ExpectedOutput = '*' },
        new GenericCoerceTest<char, Guid>{ Name = "Char To Guid ('*')", Input = '*', ExpectedResult = false },
        new GenericCoerceTest<char, int>{ Name = "Char To Int ('*')", Input = '*', ExpectedResult = true, ExpectedOutput = '*' },
        new GenericCoerceTest<char, long>{ Name = "Char To Long ('*')", Input = '*', ExpectedResult = true, ExpectedOutput = '*' },
        ...
        new GenericCoerceTest<char, uint>{ Name = "Char To UInt ('*')", Input = '*', ExpectedResult = true, ExpectedOutput = '*' },
        new GenericCoerceTest<char, Ulid>{ Name = "Char To Ulid ('*')", Input = '*', ExpectedResult = false },
        new GenericCoerceTest<char, ulong>{ Name = "Char To ULong ('*')", Input = '*', ExpectedResult = true, ExpectedOutput = '*' },
        new GenericCoerceTest<char, Uri>{ Name = "Char To Uri ('*')", Input = '*', ExpectedResult = false },
        new GenericCoerceTest<char, ushort>{ Name = "Char To UShort ('*')", Input = '*', ExpectedResult = true, ExpectedOutput = '*' },
    ...
    [
        ...
        new NonGenericCoerceTest<char, decimal>{ Name = "Char To Decimal ('*')", Input = '*', ExpectedResult = true, ExpectedOutput = '*' },
        new NonGenericCoerceTest<char, double>{ Name = "Char To Double ('*')", Input = '*', ExpectedResult = true, ExpectedOutput = '*' },
        new NonGenericCoerceTest<char, float>{ Name = "Char To Float ('*')", Input = '*', ExpectedResult = true, ExpectedOutput = '*' },
        new NonGenericCoerceTest<char, Guid>{ Name = "Char To Guid ('*')", Input = '*', ExpectedResult = false },
        new NonGenericCoerceTest<char, int>{ Name = "Char To Int ('*')", Input = '*', ExpectedResult = true, ExpectedOutput = '*' },
        new NonGenericCoerceTest<char, long>{ Name = "Char To Long ('*')", Input = '*', ExpectedResult = true, ExpectedOutput = '*' },
        ...
        new NonGenericCoerceTest<char, uint>{ Name = "Char To UInt ('*')", Input = '*', ExpectedResult = true, ExpectedOutput = '*' },
        new NonGenericCoerceTest<char, Ulid>{ Name = "Char To Ulid ('*')", Input = '*', ExpectedResult = false },
        new NonGenericCoerceTest<char, ulong>{ Name = "Char To ULong ('*')", Input = '*', ExpectedResult = true, ExpectedOutput = '*' },
        new NonGenericCoerceTest<char, Uri>{ Name = "Char To Uri ('*')", Input = '*', ExpectedResult = false },
        new NonGenericCoerceTest<char, ushort>{ Name = "Char To UShort ('*')", Input = '*', ExpectedResult = true, ExpectedOutput = '*' },
