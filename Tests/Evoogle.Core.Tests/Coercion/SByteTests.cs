...
public class SByteTests(ITestOutputHelper output) : CoerceTests(output)
{
    ...
    [
        ...
        new GenericCoerceTest<sbyte, ColorSet1>{ Name = "SByte To Enum (1)", Input = 1, ExpectedResult = true, ExpectedOutput = ColorSet1.Red },
        new GenericCoerceTest<sbyte, ColorSet1>{ Name = "SByte To Enum (42)", Input = 42, ExpectedResult = false },
    ...
    [
        ...
        new NonGenericCoerceTest<sbyte, ColorSet1>{ Name = "SByte To Enum (1)", Input = 1, ExpectedResult = true, ExpectedOutput = ColorSet1.Red },
        new NonGenericCoerceTest<sbyte, ColorSet1>{ Name = "SByte To Enum (42)", Input = 42, ExpectedResult = false },
