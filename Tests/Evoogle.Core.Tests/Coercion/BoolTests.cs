...
public class BoolTests(ITestOutputHelper output) : CoerceTests(output)
{
    ...
    [
        ...
        new GenericCoerceTest<bool, ColorSet1>{ Name = "Bool To Enum (true)", Input = true, ExpectedResult = true, ExpectedOutput = ColorSet1.Red },
    ...
    [
        ...
        new NonGenericCoerceTest<bool, ColorSet1>{ Name = "Bool To Enum (true)", Input = true, ExpectedResult = true, ExpectedOutput = ColorSet1.Red },
