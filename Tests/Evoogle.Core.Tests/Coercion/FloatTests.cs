...
public class FloatTests(ITestOutputHelper output) : CoerceTests(output)
{
    ...
    [
        ...
        new GenericCoerceTest<float, PrimaryColor>{ Name = "Float To Enum (1)", Input = 1, ExpectedResult = true, ExpectedOutput = PrimaryColor.Green },
        new GenericCoerceTest<float, PrimaryColor>{ Name = "Float To Enum (42)", Input = 42, ExpectedResult = false },
    ...
    [
        ...
        new NonGenericCoerceTest<float, PrimaryColor>{ Name = "Float To Enum (1)", Input = 1, ExpectedResult = true, ExpectedOutput = PrimaryColor.Green },
        new NonGenericCoerceTest<float, PrimaryColor>{ Name = "Float To Enum (42)", Input = 42, ExpectedResult = false },
