...
public class LongTests(ITestOutputHelper output) : CoerceTests(output)
{
    ...
    [
        ...
        new GenericCoerceTest<long, ColorSet1>{ Name = "Long To Enum (1)", Input = 1, ExpectedResult = true, ExpectedOutput = ColorSet1.Red },
        new GenericCoerceTest<long, ColorSet1>{ Name = "Long To Enum (42)", Input = 42, ExpectedResult = false },
    ...
    [
        ...
        new NonGenericCoerceTest<long, ColorSet1>{ Name = "Long To Enum (1)", Input = 1, ExpectedResult = true, ExpectedOutput = ColorSet1.Red },
        new NonGenericCoerceTest<long, ColorSet1>{ Name = "Long To Enum (42)", Input = 42, ExpectedResult = false },
