...
public class ShortTests(ITestOutputHelper output) : CoerceTests(output)
{
    ...
    [
        ...
        new GenericCoerceTest<short, ColorSet1>{ Name = "Short To Enum (1)", Input = 1, ExpectedResult = true, ExpectedOutput = ColorSet1.Red },
        new GenericCoerceTest<short, ColorSet1>{ Name = "Short To Enum (42)", Input = 42, ExpectedResult = false },
    ...
    [
        ...
        new NonGenericCoerceTest<short, ColorSet1>{ Name = "Short To Enum (1)", Input = 1, ExpectedResult = true, ExpectedOutput = ColorSet1.Red },
        new NonGenericCoerceTest<short, ColorSet1>{ Name = "Short To Enum (42)", Input = 42, ExpectedResult = false },
