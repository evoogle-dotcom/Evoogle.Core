...
public class DateTimeTests(ITestOutputHelper output) : CoerceTests(output)
{
    ...
    [
        ...
        new GenericCoerceTest<DateTime, ColorSet1>{ Name = $"DateTime To Enum ({TestDateTimeString})", Input = TestDateTime, ExpectedResult = false },
    ...
    [
        ...
        new NonGenericCoerceTest<DateTime, ColorSet1>{ Name = $"DateTime To Enum ({TestDateTimeString})", Input = TestDateTime, ExpectedResult = false },
