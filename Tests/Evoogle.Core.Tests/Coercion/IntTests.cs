...
public class IntTests(ITestOutputHelper output) : CoerceTests(output)
{
    ...
    [
        ...
        new GenericCoerceTest<int, ColorSet1>{ Name = "Int To Enum (1)", Input = 1, ExpectedResult = true, ExpectedOutput = ColorSet1.Red },
        new GenericCoerceTest<int, ColorSet1>{ Name = "Int To Enum (42)", Input = 42, ExpectedResult = false },
    ...
    [
        ...
        new NonGenericCoerceTest<int, ColorSet1>{ Name = "Int To Enum (1)", Input = 1, ExpectedResult = true, ExpectedOutput = ColorSet1.Red },
        new NonGenericCoerceTest<int, ColorSet1>{ Name = "Int To Enum (42)", Input = 42, ExpectedResult = false },
