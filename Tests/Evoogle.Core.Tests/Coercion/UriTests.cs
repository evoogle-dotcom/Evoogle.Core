...
public class UriTests(ITestOutputHelper output) : CoerceTests(output)
{
    ...
    [
        ...
        new GenericCoerceTest<Uri, PrimaryColor>{ Name = $"Uri To Enum ({TestUriString})", Input = TestUri, ExpectedResult = false },
    ...
    [
        ...
        new NonGenericCoerceTest<Uri, PrimaryColor>{ Name = $"Uri To Enum ({TestUriString})", Input = TestUri, ExpectedResult = false },
