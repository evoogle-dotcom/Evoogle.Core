...
public class DateTimeOffsetTests(ITestOutputHelper output) : CoerceTests(output)
{
    ...
    [
        ...
        new GenericCoerceTest<DateTimeOffset, ColorSet1>{ Name = $"DateTimeOffset To Enum ({TestDateTimeOffsetString})", Input = TestDateTimeOffset, ExpectedResult = false },
    ...
    [
        ...
        new NonGenericCoerceTest<DateTimeOffset, ColorSet1>{ Name = $"DateTimeOffset To Enum ({TestDateTimeOffsetString})", Input = TestDateTimeOffset, ExpectedResult = false },
