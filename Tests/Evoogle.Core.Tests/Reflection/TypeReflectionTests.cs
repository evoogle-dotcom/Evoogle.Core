...
#pragma warning disable CA1822, CS0169, CS0649, IDE0044, IDE0051, IDE0060, RCS1163, RCS1169, RCS1170, RCS1213
    ...
    public static TheoryDataRow<IXUnitTest>[] GetConstructorTheoryData =>
        [
            new GetConstructorTest { Name = "With Public And 0 Parameters", Type = typeof(ClassWithConstructors), BindingFlags = BindingFlags.Public, ParameterTypes = [], ExpectedConstructorFound = true },
        new GetConstructorTest { Name = "With Public And 1 Parameters", Type = typeof(ClassWithConstructors), BindingFlags = BindingFlags.Public, ParameterTypes = [typeof(int)], ExpectedConstructorFound = true },
        new GetConstructorTest { Name = "With Public And 2 Parameters", Type = typeof(ClassWithConstructors), BindingFlags = BindingFlags.Public, ParameterTypes = [typeof(int), typeof(string)], ExpectedConstructorFound = true },
        new GetConstructorTest { Name = "With Public And 3 Parameters", Type = typeof(ClassWithConstructors), BindingFlags = BindingFlags.Public, ParameterTypes = [typeof(int), typeof(string), typeof(bool)], ExpectedConstructorFound = false },

        new GetConstructorTest { Name = "With Public And Non Public And 0 Parameters", Type = typeof(ClassWithConstructors), BindingFlags = BindingFlags.Public | BindingFlags.NonPublic, ParameterTypes = [], ExpectedConstructorFound = true },
        new GetConstructorTest { Name = "With Public And Non Public And 1 Parameters", Type = typeof(ClassWithConstructors), BindingFlags = BindingFlags.Public | BindingFlags.NonPublic, ParameterTypes = [typeof(int)], ExpectedConstructorFound = true },
        new GetConstructorTest { Name = "With Public And Non Public And 2 Parameters", Type = typeof(ClassWithConstructors), BindingFlags = BindingFlags.Public | BindingFlags.NonPublic, ParameterTypes = [typeof(int), typeof(string)], ExpectedConstructorFound = true },
        new GetConstructorTest { Name = "With Public And Non Public And 3 Parameters", Type = typeof(ClassWithConstructors), BindingFlags = BindingFlags.Public | BindingFlags.NonPublic, ParameterTypes = [typeof(int), typeof(string), typeof(bool)], ExpectedConstructorFound = true },

        new GetConstructorTest { Name = "With Non Public And 0 Parameters", Type = typeof(ClassWithConstructors), BindingFlags = BindingFlags.NonPublic, ParameterTypes = [], ExpectedConstructorFound = false },
        new GetConstructorTest { Name = "With Non Public And 1 Parameters", Type = typeof(ClassWithConstructors), BindingFlags = BindingFlags.NonPublic, ParameterTypes = [typeof(int)], ExpectedConstructorFound = false },
        new GetConstructorTest { Name = "With Non Public And 2 Parameters", Type = typeof(ClassWithConstructors), BindingFlags = BindingFlags.NonPublic, ParameterTypes = [typeof(int), typeof(string)], ExpectedConstructorFound = false },
        new GetConstructorTest { Name = "With Non Public And 3 Parameters", Type = typeof(ClassWithConstructors), BindingFlags = BindingFlags.NonPublic, ParameterTypes = [typeof(int), typeof(string), typeof(bool)], ExpectedConstructorFound = true },
    ];

    public static TheoryDataRow<IXUnitTest>[] GetConstructorsTheoryData =>
    [
        new GetConstructorsTest { Name = "With Public", Type = typeof(ClassWithConstructors), BindingFlags = BindingFlags.Public, ExpectedConstructorCount = 3 },
        new GetConstructorsTest { Name = "With Public And Non Public", Type = typeof(ClassWithConstructors), BindingFlags = BindingFlags.Public | BindingFlags.NonPublic, ExpectedConstructorCount = 4 },
        new GetConstructorsTest { Name = "With Non Public", Type = typeof(ClassWithConstructors), BindingFlags = BindingFlags.NonPublic, ExpectedConstructorCount = 1 },
    ];
    ...
    [
        ...
        new GetFieldTest { Name = "With Public And Static", Type = typeof(ClassWithFields), BindingFlags = BindingFlags.Public | BindingFlags.Static, FieldName = "PublicStaticFieldBase", ExpectedFieldName = "PublicStaticFieldBase" },
        new GetFieldTest { Name = "With Non Public And Instance", Type = typeof(ClassWithFields), BindingFlags = BindingFlags.NonPublic | BindingFlags.Instance, FieldName = "PrivateFieldBase", ExpectedFieldName = "PrivateFieldBase" },
        new GetFieldTest { Name = "With Non Public And Static", Type = typeof(ClassWithFields), BindingFlags = BindingFlags.NonPublic | BindingFlags.Static, FieldName = "PrivateStaticFieldBase", ExpectedFieldName = "PrivateStaticFieldBase" },
    ];
    ...
    [
        ...
        new GetFieldsTest { Name = "With Declared Only And Public And Instance And Static", Type = typeof(ClassWithFields), BindingFlags = BindingFlags.DeclaredOnly | BindingFlags.Public | BindingFlags.Instance | BindingFlags.Static, ExpectedFieldNames = ["PublicField", "PublicStaticField"] },
    ...
    [
        ...
        new GetMethodTest { Name = "Public And Static And 0 Parameters", Type = typeof(ClassWithMethods), BindingFlags = BindingFlags.Public | BindingFlags.Static, ParameterTypes = [], MethodName = "PublicStaticMethodBase", ExpectedMethodName = "PublicStaticMethodBase" },
        new GetMethodTest { Name = "Public And Static And 1 Parameters", Type = typeof(ClassWithMethods), BindingFlags = BindingFlags.Public | BindingFlags.Static, ParameterTypes = [typeof(int)], MethodName = "PublicStaticMethodBase", ExpectedMethodName = "PublicStaticMethodBase" },
        new GetMethodTest { Name = "Public And Static And 2 Parameters", Type = typeof(ClassWithMethods), BindingFlags = BindingFlags.Public | BindingFlags.Static, ParameterTypes = [typeof(int), typeof(string)], MethodName = "PublicStaticMethodBase", ExpectedMethodName = "PublicStaticMethodBase" },
        new GetMethodTest { Name = "Public And Static And 3 Parameters", Type = typeof(ClassWithMethods), BindingFlags = BindingFlags.Public | BindingFlags.Static, ParameterTypes = [typeof(int), typeof(string), typeof(bool)], MethodName = "PublicStaticMethodBase", ExpectedMethodName = null },
        ...
        new GetMethodTest { Name = "Non Public And Static And 0 Parameters", Type = typeof(ClassWithMethods), BindingFlags = BindingFlags.NonPublic | BindingFlags.Static, ParameterTypes = [], MethodName = "ProtectedStaticMethodBase", ExpectedMethodName = "ProtectedStaticMethodBase" },
        new GetMethodTest { Name = "Non Public And Static And 1 Parameters", Type = typeof(ClassWithMethods), BindingFlags = BindingFlags.NonPublic | BindingFlags.Static, ParameterTypes = [typeof(int)], MethodName = "ProtectedStaticMethodBase", ExpectedMethodName = "ProtectedStaticMethodBase" },
        new GetMethodTest { Name = "Non Public And Static And 2 Parameters", Type = typeof(ClassWithMethods), BindingFlags = BindingFlags.NonPublic | BindingFlags.Static, ParameterTypes = [typeof(int), typeof(string)], MethodName = "ProtectedStaticMethodBase", ExpectedMethodName = "ProtectedStaticMethodBase" },
        new GetMethodTest { Name = "Non Public And Static And 3 Parameters", Type = typeof(ClassWithMethods), BindingFlags = BindingFlags.NonPublic | BindingFlags.Static, ParameterTypes = [typeof(int), typeof(string), typeof(bool)], MethodName = "ProtectedStaticMethodBase", ExpectedMethodName = null },
    ];
    ...
    [
        ...
        new GetMethodsTest { Name = "With Public And Static", Type = typeof(ClassWithMethods), BindingFlags = BindingFlags.Public | BindingFlags.Static, ExpectedMethodNames = ["PublicStaticMethod", "PublicStaticMethod", "PublicStaticMethod", "PublicStaticMethodBase", "PublicStaticMethodBase", "PublicStaticMethodBase"] },
        new GetMethodsTest { Name = "With Public And Instance And Static", Type = typeof(ClassWithMethods), BindingFlags = BindingFlags.Public | BindingFlags.Instance | BindingFlags.Static, ExpectedMethodNames = ["PublicMethod", "PublicMethod", "PublicMethod", "PublicStaticMethod", "PublicStaticMethod", "PublicStaticMethod", "PublicMethodBase", "PublicMethodBase", "PublicMethodBase", "PublicStaticMethodBase", "PublicStaticMethodBase", "PublicStaticMethodBase"] },
        ...
        new GetMethodsTest { Name = "With Non Public And Static", Type = typeof(ClassWithMethods), BindingFlags = BindingFlags.NonPublic | BindingFlags.Static, ExpectedMethodNames = ["PrivateStaticMethod", "PrivateStaticMethod", "PrivateStaticMethod", "ProtectedStaticMethodBase", "ProtectedStaticMethodBase", "ProtectedStaticMethodBase"] },
        new GetMethodsTest { Name = "With Non Public And Instance And Static", Type = typeof(ClassWithMethods), BindingFlags = BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Static, ExpectedMethodNames = ["PrivateMethod", "PrivateMethod", "PrivateMethod", "ProtectedMethodBase", "ProtectedMethodBase", "ProtectedMethodBase", "PrivateStaticMethod", "PrivateStaticMethod", "PrivateStaticMethod", "ProtectedStaticMethodBase", "ProtectedStaticMethodBase", "ProtectedStaticMethodBase"] },
        new GetMethodsTest { Name = "With Public And Non Public And Instance And Static", Type = typeof(ClassWithMethods), BindingFlags = BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Static, ExpectedMethodNames = ["PublicMethod", "PublicMethod", "PublicMethod", "PublicMethodBase", "PublicMethodBase", "PublicMethodBase", "PublicStaticMethod", "PublicStaticMethod", "PublicStaticMethod", "PublicStaticMethodBase", "PublicStaticMethodBase", "PublicStaticMethodBase", "PrivateMethod", "PrivateMethod", "PrivateMethod", "ProtectedMethodBase", "ProtectedMethodBase", "ProtectedMethodBase", "PrivateStaticMethod", "PrivateStaticMethod", "PrivateStaticMethod", "ProtectedStaticMethodBase", "ProtectedStaticMethodBase", "ProtectedStaticMethodBase"] },
    ];
    ...
    [
        ...
        new GetPropertyTest { Name = "With Public And Static", Type = typeof(ClassWithProperties), BindingFlags = BindingFlags.Public | BindingFlags.Static, PropertyName = "PublicStaticPropertyBase", ExpectedPropertyName = "PublicStaticPropertyBase" },
        new GetPropertyTest { Name = "With Non Public And Instance", Type = typeof(ClassWithProperties), BindingFlags = BindingFlags.NonPublic | BindingFlags.Instance, PropertyName = "PrivatePropertyBase", ExpectedPropertyName = "PrivatePropertyBase" },
        new GetPropertyTest { Name = "With Non Public And Static", Type = typeof(ClassWithProperties), BindingFlags = BindingFlags.NonPublic | BindingFlags.Static, PropertyName = "PrivateStaticPropertyBase", ExpectedPropertyName = "PrivateStaticPropertyBase" },
    ];
    ...
    [
        ...
        new GetPropertiesTest { Name = "With Public And Static", Type = typeof(ClassWithProperties), BindingFlags = BindingFlags.Public | BindingFlags.Static, ExpectedPropertyNames = ["PublicStaticProperty", "PublicStaticPropertyBase"] },
        new GetPropertiesTest { Name = "With Public And Instance And Static", Type = typeof(ClassWithProperties), BindingFlags = BindingFlags.Public | BindingFlags.Instance | BindingFlags.Static, ExpectedPropertyNames = ["PublicProperty", "PublicPropertyBase", "PublicStaticProperty", "PublicStaticPropertyBase"] },
        ...
        new GetPropertiesTest { Name = "With Non Public And Static", Type = typeof(ClassWithProperties), BindingFlags = BindingFlags.NonPublic | BindingFlags.Static, ExpectedPropertyNames = ["ProtectedInternalStaticProperty", "ProtectedStaticProperty", "InternalStaticProperty", "PrivateStaticProperty", "ProtectedInternalStaticPropertyBase", "ProtectedStaticPropertyBase", "InternalStaticPropertyBase", "PrivateStaticPropertyBase"] },
        new GetPropertiesTest { Name = "With Non Public And Instance And Static", Type = typeof(ClassWithProperties), BindingFlags = BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Static, ExpectedPropertyNames = ["ProtectedInternalProperty", "ProtectedInternalStaticProperty", "ProtectedProperty", "ProtectedStaticProperty", "InternalProperty", "InternalStaticProperty", "PrivateProperty", "PrivateStaticProperty", "ProtectedInternalPropertyBase", "ProtectedInternalStaticPropertyBase", "ProtectedPropertyBase", "ProtectedStaticPropertyBase", "InternalPropertyBase", "InternalStaticPropertyBase", "PrivatePropertyBase", "PrivateStaticPropertyBase"] },
        new GetPropertiesTest { Name = "With Public And Non Public And Instance And Static", Type = typeof(ClassWithProperties), BindingFlags = BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Static, ExpectedPropertyNames = ["PublicProperty", "PublicStaticProperty", "ProtectedInternalProperty", "ProtectedInternalStaticProperty", "ProtectedProperty", "ProtectedStaticProperty", "InternalProperty", "InternalStaticProperty", "PrivateProperty", "PrivateStaticProperty", "PublicPropertyBase", "PublicStaticPropertyBase", "ProtectedInternalPropertyBase", "ProtectedInternalStaticPropertyBase", "ProtectedPropertyBase", "ProtectedStaticPropertyBase", "InternalPropertyBase", "InternalStaticPropertyBase", "PrivatePropertyBase", "PrivateStaticPropertyBase"] },
    ];
